...
<div class="vale-capture-facts">
  <div><strong>Source</strong><span>Live Windows capture</span></div>
  <div><strong>Field</strong><span>COSMOS</span></div>
  <div><strong>Render</strong><span>1280 × 720 demo</span></div>
  <div><strong>Audio</strong><span>None</span></div>
</div>
